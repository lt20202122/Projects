      ...
      <div className="px-4 md:px-[13vw]">
        ...
        <div className="">
          ...
          <ul className="list-disc pl-5 text-[18px]">
            ...
            <li className="">Diese Veranstaltung findet in Kooperation mit der Kreisvolkshochschule Gifhorn statt und kann nur über die <a href="https://kvhs-gifhorn.de/Veranstaltung/cmx690b59b05d841.html" className="relative before:absolute before:w-0 before:h-0.5 before:bottom-0 before:left-0 before:bg-[#5c7c3f] hover:before:w-full before:transition-all before:duration-300 inline-block text-[#265100]">Website der KVHS</a>  gebucht werden.​</li>
            <li className="text-[#738d5c] font-bold">Mittwoch, 5. Mai 2026 | 17.00 - 19.15 Uhr</li>
          </ul>
