    ...
    return (
        <div className={`min-w-screen relative md:px-[13vw] px-[5vw]`}>
            ...
            <ul className="text-[18px] list-disc pl-5 flex gap-0.5 flex-col mb-10">
                ...
                <li className="text-[#738d5c] font-bold">Sonntag, 31. Mai 2026 | 13.30 - 16.30 Uhr</li>

                <li className="text-[#738d5c] font-bold">Sonntag, 27. September 2026 | 13.30 - 16.30 Uhr</li>
            </ul>
