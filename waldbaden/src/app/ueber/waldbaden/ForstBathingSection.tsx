...
export default function ForestBathingSection() {
  return (
    <section className="px-4 md:px-[17vw] flex-col hidden md:flex mb-10">
      <div className="w-[65.5vw] h-[66vh] relative my-10 hidden md:block">
        <Image
          src="/wald15.webp"
          alt="Eindrucksvoller Waldweg in der Abenddämmerung - Waldbaden Erlebnis"
          fill
          loading="lazy"
      ...
      <div className="w-[65.5vw] h-[66vh] relative mb-7 mt-5 hidden md:block">
        <Image
          src="/wald16.webp"
          alt="Detailaufnahme eines moosbewachsenen Baumstamms im Wald"
          fill
          loading="lazy"
          className="object-contain"
        />
      ...
      <div className="w-[65.5vw] h-[66vh] relative my-10 mb-10 hidden md:block">
        <Image
          src="/wald17.webp"
          alt="Frisches grünes Moos am Waldboden - Fokus auf Naturdetails"
          fill
          loading="lazy"
          className="object-contain"
        />
      ...
      <div className="w-[65.5vw] h-[66vh] relative my-10 mb-10 hidden md:block">
        <Image
          src="/wald18.webp"
          alt="Stimmungsvoller Sonnenuntergang hinter Silhouetten von Waldbäumen"
          fill
          loading="lazy"
          className="object-contain"
        />
